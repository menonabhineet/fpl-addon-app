...
export default function LeagueModal({ isOpen, onClose, onLeagueCreatedOrJoined }: LeagueModalProps) {
  ...
  return createPortal(
    ...
    >
      <div
        className="relative w-full max-w-md bg-slate-900 border border-slate-700/80 rounded-3xl p-6 sm:p-8 shadow-2xl text-slate-100 animate-in zoom-in-95 duration-150 transform-gpu"
